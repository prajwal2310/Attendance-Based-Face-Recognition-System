...
message = tk.Label(window, text="REVA UNIVERSITY" ,bg="white"  ,fg="black"  ,width=20  ,height=2,font=('Times New Roman', 25, 'bold')) 

message.place(x=1150, y=760)



message = tk.Label(window, text="ATTENDANCE MANAGEMENT PORTAL" ,bg="orange"  ,fg="black"  ,width=40  ,height=1,font=('Times New Roman', 35, 'bold underline')) 
